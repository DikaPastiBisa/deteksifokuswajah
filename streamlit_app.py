...
# LOAD MODEL
# ==============================================================
# model disimpan dengan keras (bukan tf.keras), jadi pakai keras.models.load_model
model = keras.models.load_model("mobilenetv3_focus_final.keras", compile=False)
IMG_SIZE = (224, 224)
...
source = st.sidebar.selectbox(
    "Pilih Sumber Kamera:", ["Webcam (0)", "Webcam (1)", "IP Camera URL", "Upload Video"]
)
...
while True:
    ...
    # Kamera dibuat mirror (seperti awal programmu)
    ...
    if fokus + tidak > 0:
        ...
        plt.text(0.5, 0.5, "Belum Ada Data", ha="center", va="center")
